...
print("Starts with D:")
# Creates variable 'a' and loops through humans list and returns each value where the first index = D
...
c = [i.name for i in humans if i.name[0] in [chr(letter) for letter in range(67, 72)]]
print(c)
